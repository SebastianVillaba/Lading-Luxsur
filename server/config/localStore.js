...
const INITIAL_DATA = {
  ...
  settings: {
    ...
    instagramUrl: "https://www.instagram.com/luxsurhotelboutique/?hl=es",
    facebookUrl: "https://www.facebook.com/HotelLuxsur/?locale=es_LA",
...
export function getLocalData() {
  try {
    if (fs.existsSync(DATA_FILE)) {
      ...
      if (!parsed.history) {
        parsed.history = INITIAL_DATA.history;
        saveLocalData(parsed);
      }
      return parsed;
    }

      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            disabled={isSaving}
            className="px-6 py-2.5 bg-[#3D1347] hover:bg-[#2A0B33] text-[#D4AF37] font-bold text-xs sm:text-sm rounded-xl shadow-lg shadow-purple-950/20 transition-all flex items-center gap-2 cursor-pointer border border-[#D4AF37]/30 disabled:opacity-50"
          >
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-semibold transition-all cursor-pointer ${
                activeTab === tab.id
                  ? 'bg-[#3D1347] text-[#D4AF37] shadow-md shadow-purple-950/20'
            ...
            <div className="space-y-5 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <Link
                      to="/admin/categories"
                      target="_blank"
                      className="text-[11px] font-semibold text-[#3D1347] hover:underline"
                    >
                      + Gestionar
                    </Link>
                  </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#3D1347] font-mono text-xs bg-slate-50 disabled:opacity-60"
                  />
                </div>
              </div>
              ...
              <div>
                    ...
                    <button
                      ...
                      className={`px-3 py-1 rounded-lg text-xs font-semibold transition-colors cursor-pointer border ${
                        formData.badge === b.value
                          ? 'bg-[#3D1347] text-[#D4AF37] border-[#3D1347]'
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-xl border border-slate-200 text-xs focus:outline-none focus:ring-2 focus:ring-[#3D1347]"
                />
              </div>

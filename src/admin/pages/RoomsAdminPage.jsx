    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Layers className="w-4 h-4 text-[#5e265e]" />
            <span>Gestionar Categorías ({allCategories.length})</span>
          </Link>
          <Link
            to="/admin/rooms/new"
            className="inline-flex items-center gap-2 px-5 py-3 bg-gradient-to-r from-[#5e265e] to-[#8d398d] hover:from-[#8d398d] hover:to-[#5e265e] text-white font-bold text-xs sm:text-sm rounded-xl shadow-lg shadow-purple-950/20 transition-all border border-purple-400/40 flex-shrink-0 cursor-pointer"
          >
      ...
      <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-[#5e265e]"
          />
        </div>
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-colors cursor-pointer ${
                selectedCategory === cat
                  ? 'bg-[#5e265e] text-white shadow-xs'
                ...
                <div className="relative h-48 bg-slate-900 overflow-hidden">
                  ...
                  {room.badge && (
                    <div className="absolute top-3 left-3 z-10">
                      <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-[#4d1a4d] text-white border border-purple-400/50 shadow-md">
                        {room.badge}
                      </span>
                    </div>
                  )}
                ...
                <div className="p-5">
                  <div className="grid grid-cols-3 gap-1.5 py-2 px-2 bg-slate-50 rounded-xl border border-slate-200/60 mb-4 text-center text-slate-700 text-xs font-medium">
                    <div className="flex flex-col items-center justify-center p-1">
                      <Users className="w-3.5 h-3.5 text-[#5e265e] mb-0.5" />
                    ...
                    <div className="flex flex-col items-center justify-center p-1 border-x border-slate-200">
                      <Maximize2 className="w-3.5 h-3.5 text-[#5e265e] mb-0.5" />
                      <span>{room.size}</span>
                    </div>
                    <div className="flex flex-col items-center justify-center p-1">
                      <Bed className="w-3.5 h-3.5 text-[#5e265e] mb-0.5" />
              ...
              <div className="p-4 bg-slate-50 border-t border-slate-100 flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <Link
                    ...
                    className="px-3.5 py-1.5 bg-[#5e265e] hover:bg-[#8d398d] text-white rounded-xl text-xs font-bold transition-colors flex items-center gap-1 shadow-xs cursor-pointer"
                  >

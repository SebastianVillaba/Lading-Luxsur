                ...
                {gallery.map((img, idx) => (
                  <button
                    ...
                    className={`w-16 h-12 rounded-lg overflow-hidden border-2 flex-shrink-0 transition-all cursor-pointer ${
                      selectedImageIdx === idx ? 'border-[#5e265e] scale-105' : 'border-transparent opacity-60 hover:opacity-100'
                    }`}
                  >
          ...
          <div className="lg:col-span-6 p-6 sm:p-8 flex flex-col justify-between bg-white">
            <div>
              ...
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs font-bold uppercase tracking-widest text-[#5e265e]">
                  {room.category}
                </span>
                <div className="flex items-center gap-1 text-xs text-[#5e265e] font-semibold">
                  <Star className="w-3.5 h-3.5 fill-[#5e265e] text-[#5e265e]" />
              ...
              <div className="grid grid-cols-3 gap-2 py-3 px-4 bg-slate-50 rounded-xl border border-slate-200 mb-6 text-xs font-medium text-slate-700">
                <div className="flex items-center gap-1.5">
                  <Users className="w-4 h-4 text-[#5e265e]" />
                  <span>{room.guestsLabel}</span>
                </div>
                <div className="flex items-center gap-1.5 border-x border-slate-200 px-2">
                  <Maximize2 className="w-4 h-4 text-[#5e265e]" />
                  <span>{room.size}</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <Bed className="w-4 h-4 text-[#5e265e]" />

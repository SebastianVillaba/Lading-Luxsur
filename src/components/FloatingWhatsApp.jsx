...
export default function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end group">
      ...
      {/* TOOLTIP BALOON */}
      {showTooltip && (
        <div className="mb-3 bg-slate-900 text-white text-xs font-medium py-2.5 px-4 rounded-2xl shadow-2xl border border-emerald-500/40 flex items-center gap-2 max-w-xs animate-bounce">
      ...
      <a
        ...
        className="relative flex items-center justify-center w-14 h-14 rounded-full bg-emerald-500 hover:bg-emerald-600 text-white shadow-2xl transition-all duration-300 hover:scale-110 group-hover:shadow-emerald-500/50"
      >
        {/* PULSE RINGS */}

  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center pt-28 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
        ...
        {/* CATEGORY BADGE */}
        <div className="inline-flex items-center gap-2 bg-[#3D1347]/90 border border-[#D4AF37]/50 backdrop-blur-md px-4 py-1.5 rounded-full shadow-lg mb-6 animate-fadeIn">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-serif font-bold text-white tracking-tight max-w-5xl leading-tight mb-4 drop-shadow-lg">
          {settings.hotelName || 'LuxSur Hotel Boutique'} <span className="gold-gradient-text">****</span>
        </h1>
        ...
        <div className="w-full max-w-5xl bg-[#2A0B33]/90 backdrop-blur-xl border border-[#D4AF37]/40 rounded-2xl p-4 sm:p-6 shadow-2xl gold-border-glow">
          ...
          <form onSubmit={handleSearch} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
            ...
            <div className="flex flex-col text-left">
              <label className="text-xs font-medium text-amber-100/80 mb-1 flex items-center gap-1">
                <Calendar className="w-3.5 h-3.5 text-[#D4AF37]" /> Fecha Entrada
              </label>
              <input
                type="date"
                value={checkin}
                ...
                className="w-full bg-white text-slate-900 text-sm font-medium px-3 py-2.5 rounded-xl border border-amber-300/40 focus:outline-none focus:ring-2 focus:ring-[#D4AF37]"
                required
              />
            </div>
            ...
            <div className="flex flex-col text-left">
              <label className="text-xs font-medium text-amber-100/80 mb-1 flex items-center gap-1">
                <Calendar className="w-3.5 h-3.5 text-[#D4AF37]" /> Fecha Salida
              </label>
              <input
                type="date"
                value={checkout}
            ...
            <div className="flex flex-col text-left">
              <label className="text-xs font-medium text-amber-100/80 mb-1 flex items-center gap-1">
                <Users className="w-3.5 h-3.5 text-[#D4AF37]" /> Huéspedes
              </label>
              <select
                value={guests}
            ...
            <div className="flex flex-col text-left">
              <label className="text-xs font-medium text-amber-100/80 mb-1 flex items-center gap-1">
                <BedDouble className="w-3.5 h-3.5 text-[#D4AF37]" /> Habitación
              </label>
              <select
                value={selectedRoom}
